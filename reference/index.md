...
- [`filter_datetime()`](https://atools.trackyverse.org/reference/filter_datetime.md)
  ...
  time period
- [`filter_dep()`](https://atools.trackyverse.org/reference/filter_dep.md)
  : Filter rows from the @dep slot
- [`filter_det()`](https://atools.trackyverse.org/reference/filter_det.md)
  : Filter rows from the @det slot
- [`filter_obs()`](https://atools.trackyverse.org/reference/filter_obs.md)
  : Filter rows from the @obs slot
- [`filter_ping_dev()`](https://atools.trackyverse.org/reference/filter_ping_dev.md)
